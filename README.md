...
42 commands, real filesystem freeze, zero dependencies. Supports Mac OS X 10.4 Tiger through macOS 26 Tahoe. Works as both a macOS guest agent and an OS X guest agent for legacy VMs.
...
| [All Platforms](docs/PLATFORMS.md) | Plain QEMU setup, ISA serial transport |
...
| [Commands](docs/COMMAND_STATUS.md) | All 42 commands with status, Linux parity, privilege requirements |
